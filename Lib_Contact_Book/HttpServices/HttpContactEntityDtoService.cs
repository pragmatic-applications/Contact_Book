...
{
    public class HttpContactEntityDtoService : HttpEntityService<ContactEntityDto>
    {
        public HttpContactEntityDtoService(HttpClient httpClient) : base(httpClient)
        {
        ...
        public async Task AddEntityAsync(ContactEntityDto model) => await this.PostAsync(model);

        public async Task EditEntityAsync(int id, ContactEntityDto model) => await this.PutAsync(id, model);
