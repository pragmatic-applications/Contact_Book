...
namespace Contact_Book_Server_Api.Database.Migrations.ApplicationDbContextMigrations
{
    ...
    [Migration("20210802094133_ApplicationDbContext_Initial")]
            ...
            modelBuilder.Entity("Domain.ContactEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 8, 2, 9, 41, 33, 204, DateTimeKind.Unspecified).AddTicks(5584), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "jane@doe.com",
                            FirstName = "Jane",
                            Image = "Default.png",
                            IsChecked = false,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 8, 2, 9, 41, 33, 204, DateTimeKind.Unspecified).AddTicks(8082), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 8, 2, 9, 41, 33, 204, DateTimeKind.Unspecified).AddTicks(8089), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 8, 2, 9, 41, 33, 204, DateTimeKind.Unspecified).AddTicks(8091), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "8da4afe6-2245-4c25-9bab-00c0142d3f75",
                            Name = "Admin",
                        ...
                        {
                            Id = "2",
                            ConcurrencyStamp = "8933ec88-fd12-4194-ae5b-1ad4032ef1d6",
                            Name = "SuperAdmin",
                        ...
                        {
                            Id = "3",
                            ConcurrencyStamp = "5aec59fc-bad1-47d7-80b5-72edbba2e554",
                            Name = "Editor",
                        ...
                        {
                            Id = "4",
                            ConcurrencyStamp = "fd4c5759-7171-42f9-8852-7c417a0bb7c0",
                            Name = "RegularUser",
